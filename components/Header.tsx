  ...
  return (
    <header 
      className={`fixed top-0 left-0 w-full z-[1000] transition-all duration-500 ${
        scrolled 
          ? 'h-20 bg-[#05080f]/80 backdrop-blur-xl border-b border-white/5 shadow-2xl' 
          : 'h-24 bg-transparent'
      } flex items-center`}
    >
        ...
        {isMobileMenuOpen && (
          <>
            ...
            <motion.div 
              ...
              className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[1099] lg:hidden"
            />
            ...
            <motion.div 
              ...
              animate="opened"
              exit="exit"
              className="fixed top-0 right-0 bottom-0 w-[85%] max-w-[400px] z-[1100] bg-[#05080f] flex flex-col shadow-[-20px_0_60px_rgba(0,0,0,0.5)] border-l border-white/5"
            >
              ...
              <div className="p-8 border-t border-white/5 bg-[#080c14]/50 backdrop-blur-md">
