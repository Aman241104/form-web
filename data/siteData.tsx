...
export const services = [
  ...
  {
    id: 'cas',
    title: 'Client Advisory Services (CAS)',
    desc: 'Move beyond compliance — deliver proactive, strategic financial guidance your clients can\'t get anywhere else.',
    features: ['Virtual CFO Services', 'Performance Dashboards', 'Business Benchmarking', 'Profitability Analysis'],
    fullContent: `Client Advisory Services is where compliance ends and true partnership begins. We help you deliver ongoing, proactive financial guidance — transforming your firm from a once-a-year tax preparer into a year-round trusted advisor.

    Our CAS Offerings:
    - Virtual CFO Services — Strategic financial leadership without the full-time cost
    - Performance Dashboards — Real-time KPIs and financial metrics at a glance
    - Business Benchmarking — See how your clients stack up against industry peers
    - Profitability Analysis — Identify margin leaks and revenue opportunities
    - Cash Flow Management — Proactive planning to prevent shortfalls
    - Technology Stack Consulting — Helping clients choose the right financial tools`,
    featured: false,
    icon: (
